<template>
  <section class="relative py-16 px-4">
    <div
      class="w-full max-w-screen-xl mx-auto bg-gradient-to-l from-white/70 to-white/50 bg-opacity-40 lg:p-16 p-6 rounded-lg"
    >
      <div
        class="w-full max-w-screen-xl mx-auto text-xl font-semibold pb-16 text-black font-fa"
      >
        <h2>پتومن یک اپلیکیشن برای تمام نیاز حیوانات</h2>
        <p class="text-gray-700 text-md pt-4 font-light">تو چی نیاز داری؟</p>
      </div>
