<template>
  <Transition enter-from-class="transform  duration-500 transition opacity-0"
    enter-to-class="transform  duration-500 transition opacity-100"
    leave-from-class="transform  duration-500 transition opacity-100"
    leave-to-class="transform  duration-500 transition opacity-0">
    <slot :ds="{
      dsIndexes: indexes,
      dsShowEntries,
      dsResultsNumber,
...
<script>
import datasetI18n from '@/i18n/fa.js'
